...
public class TeacherLoginWindow extends JFrame implements ActionListener {
    ...
    public TeacherLoginWindow() {
        ...
        JLabel loginText = new JLabel("Log In as Teacher!");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == goBack) {
            ...
            if (TeacherDAO.teacherLogin(username.getText(), String.valueOf(password.getPassword()))) {
                setVisible(false);
                new TeacherHomePage();
